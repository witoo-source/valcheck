...
export default function Navbar(): JSX.Element {
  ...
  return (
    <nav className="fixed top-0 w-full md:backdrop-blur-2xl h-25 z-10">
      ...
      <div className="flex w-full justify-end items-center">
        <button
          ...
          className="md:hidden p-3 text-white focus:outline-none z-20 mt-5 mr-10 backdrop-blur-3xl rounded-2xl"
        ...
        {menuOpen && (
          <ul className="md:hidden flex flex-col gap-4 backdrop-blur-3xl text-white absolute top-0 left-0 w-full p-5 rounded font-[val] font-bold text-xl shadow-lg z-10">
            {navItems.map((item) => (
